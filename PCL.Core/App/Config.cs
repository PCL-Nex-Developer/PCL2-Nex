...
public static partial class Config
{
    ...
    /// 插件配置。
    /// </summary>
    [ConfigGroup("Plugin", ConfigSource.Local)] partial class PluginConfigGroup
    {
        /// <summary>
    ...
    [ConfigGroup("Launch")] partial class LaunchConfigGroup
    {
        ...
        /// 自定义左下角版本信息。
        /// </summary>
        [ConfigItem<string>("LaunchArgumentInfo", "PCLNex", ConfigSource.Local)] public partial string TypeInfo { get; set; }
