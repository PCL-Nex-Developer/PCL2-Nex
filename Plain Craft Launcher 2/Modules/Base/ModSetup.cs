...
{
    private const string DefaultWindowTitleText = "PCL Nex";
    ...
    public static void ApplyAll()
    {
        ...
        UiLogoText(Config.Preference.WindowTitleCustomText, true);
        ...
        switch (value)
        {
            ...
            case 2: // 联网
            {
                ...
                CustomEventService.SetEventData(ModMain.frmSetupUI.HintCustom,
                    "https://github.com/PCL-Nex-Developer/PCL2-Nex/discussions");
                break;
            }
            case 3: // 预设
            {
    ...
    public static void UiLogoType(int value)
    {
        ...
        switch (value)
        {
            case 0: // 无
            {
                ...
                ModMain.frmMain.NexLogo.Visibility = Visibility.Collapsed;
                if (ModMain.frmSetupUI is not null)
                {
            ...
            case 1: // 默认
            {
                ...
                ModMain.frmMain.LabTitleLogo.Text = DefaultWindowTitleText;
                ModMain.frmMain.ImageTitleLogo.Visibility = Visibility.Collapsed;
                ModMain.frmMain.NexLogo.Visibility = Visibility.Collapsed;
                if (ModMain.frmSetupUI is not null)
                {
    ...
    public static void UiLogoText(string value, bool useDefaultWhenEmpty = false)
    {
        ModMain.frmMain.LabTitleLogo.Text = useDefaultWhenEmpty && string.IsNullOrWhiteSpace(value)
            ? DefaultWindowTitleText
            : value;
    }
