...
public partial class PageLaunchRight : IRefreshable
{
    ...
    private void Init()
    {
        ...
        // Nex 版提示
        PanHint.Visibility = States.Hint.NexMessage
            ? Visibility.Visible
        ...
        <local:MyIconButton Height=""22"" Width=""22"" Margin=""9"" VerticalAlignment=""Top"" HorizontalAlignment=""Right"" 
            ...
            SvgIcon=""lucide/refresh-cw"" />
                ...
                case 8:
                    ...
                    url = "https://github.com/Deep-Dark-Forest/PCL-GitHub-Dashboard-Homepage/raw/refs/heads/main/Custom.xaml";
                    content = LoadFromNetwork(url);
                    break;
                ...
                case 14:
                    LogWrapper.Info("[Page] 主页预设：PCL Nex 公告栏");
